...
"""
# in python 3, range will return a Range object instead of a list like in python 2.
# you can convert range to list with list() typecast.
# However, in the actual code, you should always use range() because it is concise,
# flexible and performs better.


first_list = range(10)
second_list = range(4, 8)
third_list = range(5, 21, 5)
...
def two_inputs(first, second):
    print(first, second)


two_inputs(int_list, third_list)
