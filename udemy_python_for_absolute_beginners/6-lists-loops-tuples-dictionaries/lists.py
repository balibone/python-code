...
"""
# ----------------------------------------------------------------------------------------------------------------------
rockList = ["Bob Dylan", "Like a", "Rolling Stone"]
print(rockList.index("Rolling Stone"))
rockList.insert(0, "1965")
print(rockList)
# ----------------------------------------------------------------------------------------------------------------------
"""
.remove() and .pop()
...
"""
# ----------------------------------------------------------------------------------------------------------------------
starList = ["McCartney", "Lennon", "Starr", "Harrison", "Sutcliffe"]
starList.remove("Sutcliffe")
print(starList)
print(starList.pop(1))
print(starList.pop(2))
print(starList)
# ----------------------------------------------------------------------------------------------------------------------
